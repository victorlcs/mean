...
export const addPost = createAction(postActionNames.SET_POST,props<{data:Post[],count:number}>());
...
export const getPosts = createAction(postActionNames.GET_POSTS,props<{postsPerPage: number, currentPage: number}>());
export const getPostsError = createAction(postActionNames.GET_POSTS_ERROR,props<{errorMsg:string}>());